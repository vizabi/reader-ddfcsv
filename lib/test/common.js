...
exports.tooManyQueryDefinitionErrors = new RegExp(`Too many query definition errors \\[repo: systema_globalis\\]`);
exports.notExpectedError = 'This should never be called.';
exports.expectPromiseRejection = async (options) => {
    let actualErrors;
    const { promiseFunction, args, expectedErrors } = options;
    try {
