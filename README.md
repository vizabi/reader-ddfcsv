...
```
DDFCsvReader = require('https://unpkg.com/@vizabi/reader-ddfcsv@4.5.3')
```

which will redirect to https://unpkg.com/@vizabi/reader-ddfcsv@4.5.3/dist/reader-ddfcsv.js
